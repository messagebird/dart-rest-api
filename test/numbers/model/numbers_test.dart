...
void main() {
  group('Numbers', () {
    test('should deserialize from list response json', () {
    ...
    test('should deserialize from search response json', () {
      final Numbers numbers = Numbers.fromJson(
          File('test_resources/available_phone_numbers.json')
              .readAsStringSync());
      ...
      expect(numbers.items[0].features[0], equals(Feature.sms));
      expect(numbers.items[0].features[1], equals(Feature.voice));
      expect(numbers.items[0].locality, equals(''));
      expect(numbers.items[0].number, equals('3197010260188'));
      expect(numbers.items[0].region, equals(''));
      expect(numbers.items[0].type, equals(PhoneNumberType.mobile));
    });
  });
}
