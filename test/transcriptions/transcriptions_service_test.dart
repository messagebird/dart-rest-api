...
void main() {
  group('TranscriptionService', () {
    ...
    test('should read a transcription', () async {
      final Transcription transcription = await transcriptionsService.read(
    ...
    test('should download a transcription', () async {
      await transcriptionsService
          .download(
              'e7dcb02a-229b-4ee8-8a44-3b696c137f1c',
              '0099622a-54cd-4f50-ae6c-50517159dfe7',
              '9bb3518a-7729-41bf-944c-17ba8d0a5563',
